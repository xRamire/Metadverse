...
const Navbar = () => (
  ...
  >
    ...
    <div className={`${styles.innerWidth} mx-auto flex justify-between gap-8 z-20 relative`}>
      <img src="/search.svg" alt="search" className="w-[24px] h-[24px] object-contain cursor-pointer" />
      <h2 className="font-extrabold text-[24px] leading-[30px] text-white">METADVERSE</h2>
